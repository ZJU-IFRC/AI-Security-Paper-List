...
| 4  | FINE-TUNING ALIGNED LANGUAGE MODELS COMPROMISES SAFETY, EVEN WHEN USERS DO NOT INTEND TO!               |      | https://github.com/LLM-Tuning-Safety/LLMs-Finetuning-Safety | 2024 | ICLR   |
...
| ID  | Paper Title                                                                                | Type                  | Code                                                        | Year | Source  |
|-----|--------------------------------------------------------------------------------------------|-----------------------|-------------------------------------------------------------|------|---------|
| 1   | Jailbroken: How Does LLM Safety Training Fail?                                             | Large Language Models | https://github.com/corca-ai/awesome-llm-security            | 2023 | NeurIPS |
| 2   | Rethinking Bias Mitigation: Fairer Architectures Make for Fairer Face Recognition          | Bias Mitigation       | https://github.com/dooleys/FR-NAS                           | 2023 | NeurIPS |
| 3   | Privacy Auditing with One Training Run                                                     | Differential Privacy  |                                                             | 2023 | NeurIPS |
| 4   | Students Parrot Their Teachers: Membership Inference on Model Distillation                 | Privacy               |                                                             | 2023 | NeurIPS |
| 5   | User-Level Differential Privacy With Few Examples Per User                                 | Differential Privacy  |                                                             | 2023 | NeurIPS |
| 6   | Evaluating the Moral Beliefs Encoded in LLMs                                               | Language Models       | https://github.com/ninodimontalcino/moralchoice             | 2023 | NeurIPS |
| 7   | In-Context Impersonation Reveals Large Language Models' Strengths and Biases               | large language models | https://github.com/ExplainableML/in-context-impersonation.  | 2023 | NeurIPS |
| 8   | ProPILE: Probing Privacy Leakage in Large Language Models                                  | Large language model  |                                                             | 2023 | NeurIPS |
| 9   | Principle-Driven Self-Alignment of Language Models from Scratch with Minimal Human Supervision | Large Language Models | https://github.com/IBM/Dromedary                            | 2023 | NeurIPS |
| 10  | Differentially Private Image Classification by Learning Priors from Random Processes       | Differential Privacy  | https://github.com/inspire-group/dp-randp                   | 2023 | NeurIPS |
| 11  | Participatory Personalization in Classification                                            | Data Privacy          |                                                             | 2023 | NeurIPS |
| 12  | Stable Diffusion is Unstable                                                               | Diffusion Model       | https://github.com/duchengbin8/Stable_Diffusion_is_Unstable | 2023 | NeurIPS |
